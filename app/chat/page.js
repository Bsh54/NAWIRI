...
const LANG_CONFIG = {
  en:  { native: "English",  flag: null,  sub: "",         local: false },
  fr:  { native: "Français", flag: null,  sub: "",         local: false },
  fon: { native: "Fɔngbe",   flag: "bj",  sub: "Bénin",   local: true  },
  wo:  { native: "Wolof",    flag: "sn",  sub: "Sénégal", local: true  },
  tw:  { native: "Twi",      flag: "gh",  sub: "Ghana",   local: true  },
};
...
function LangCard({ code, onSelect }) {
  ...
  return (
    ...
    >
      {cfg.flag && (
        <img
          src={`https://flagcdn.com/w40/${cfg.flag}.png`}
          srcSet={`https://flagcdn.com/w80/${cfg.flag}.png 2x`}
          width="40" height="27"
          alt={cfg.sub}
          style={{ borderRadius: 4, margin: "0 auto 10px", display: "block", objectFit: "cover" }}
        />
      )}
      <div style={{
        fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700,
